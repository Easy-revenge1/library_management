    ...
    <form action="upload.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="user-details">
        ...
        <div class="input-box">
          ...
          <select class="slt" name="book_language" class="form-control form-control-lg" required>
        ...
        <div class="input-box">
          ...
          <select class="slt" name="category_id" class="form-control form-control-lg" required>
