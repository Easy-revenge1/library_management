...
if (isset($_POST['submit']) && isset($_GET['id'])) {
  ...
  $query = "UPDATE user SET user_name = ?, user_email = ?, user_contact = ?, user_status = ? WHERE user_id = ?";

  // Create a prepared statement
  $stmt = mysqli_prepare($conn, $query);

  // Bind the parameters to the prepared statement
  mysqli_stmt_bind_param($stmt, "ssssi", $u_name, $u_email, $u_contact, $u_status, $_GET['id']);
