...
<body>
  <div class="fpBox">
    <span><button class="backButton" onclick="window.location.href='UserLogin.php'"><i
          class="arrow left icon"></i></button></span>
    <span class="ui header" id="fpText">
      <p>FORGOT PASSWORD</p>
    </span>
