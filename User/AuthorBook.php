...
// 查询该作者的所有书籍和作者描述
$authorDetailsQuery = "SELECT DISTINCT book.*, author.author_description FROM book INNER JOIN book AS author ON book.book_author = author.book_author WHERE book.book_author = ?";
$stmt = mysqli_prepare($conn, $authorDetailsQuery);
...
<body>
  <div class="authorBox">
    <div class="authorInfo" id="authorInfo">
      ...
      <p class="ui authorName horizontal divider">
        <?php echo $authorName; ?>
      </p>
...
s60.2,40,120,40s59.8,0,59.8,0l0.2,143H-60V96L-40,95.6z"></path>
  ...
  <div class="AuthorDetail">
    <div class="authorCollection">
      <p class="ui bookFrom horizontal divider">Book From
        <?php echo $authorName; ?>
      </p>


      <div class="slider" id="bookList">
        <?php mysqli_data_seek($result, 0); // 重置指针位置，以便从第一本书开始显示 ?>
        <?php if (mysqli_num_rows($result) > 0) {
          while ($book = mysqli_fetch_assoc($result)) { ?>
            <div class="book-cover">
              ...
              <button class="hidden-button" onclick="redirectToBookDetails(<?= $book['book_id'] ?>)">
                View Detail
              </button>
              <img src="<?php echo $book['book_cover']; ?>" alt="<?php echo $book['book_title']; ?>" class="book-image">
            </div>
          <?php }
        } else { ?>
...
<script>
  ...
  let elmDesign = document.getElementById('authorInfo');

  window.addEventListener('scroll', function () {
    let value = window.scrollY;
    elmDesign.style.top = value * 0.40 + 'px';
  })
</script>
<style>
  /* ...................................................................................................................... */
