...
<body>
  ...
  <div class="change-pass-box">
    <a href="UserProfile.php" style="position:absolute; left:20px; top:36px; color:#000; font-size:20px;"><i
    ...
    <div class="change-pass-form">
      ...
      <form action="ChangePassword.php" method="POST">
        ...
        <div class="lboxcss q-mt-md">
          ...
          <input type="password" class="lbox-input" name="confirm_password" id="passwordInput3" autocomplete="off"
            required>
