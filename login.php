...
if(isset($_POST['submit'])){
  if(!empty($_POST['u_name']) && !empty($_POST['u_pass'])){
    ...
    $Query="SELECT * FROM user WHERE u_name='".$U_name."' AND u_password='".$U_pass."'";
    ...
    if($rows==1){
      ...
      $_SESSION["id"]=$row[0];
      echo "<script>window.location.href='demo2.php';
           alert('Hola $U_name, Welcome to DIGITAL Library');</script>";
    }else{      
     ...
     <form action="login.php" method="POST">
      <div class="leftinput">
       <p class="logintext">LOGIN</p>
        <input class="logininput" type="text" name="u_name" placeholder="USERNAME">
        <input class="logininput" type='password' name='u_pass' placeholder="PASSWORD">
