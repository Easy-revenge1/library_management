        ...
        <div class="conta ">
          <form action="login_admin.php" method="POST">
            <div class="leftinput">
              ...
              <input class="logininput" type="text" name="admin_name" placeholder="Enter Your Username" value="Chiew Hao Er" required>
              <input class="logininput" type='password' name='admin_pass' placeholder="Enter Your Password" value="123" required>
